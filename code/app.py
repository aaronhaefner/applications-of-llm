...
def run_experiment(varying_param: str, varying_values: list):
    ...
    for result in results:
        print(f"Training time: {result['train_runtime']:.2f} s, "
...
if __name__ == '__main__':
    ...
    if arg == "train":
        run_experiment(varying_param='learning_rate', varying_values=[1e-7, 5e-7, 1e-6, 5e-6])

    elif arg == "finetune":
        run_experiment(varying_param='learning_rate', varying_values=[1e-7, 5e-7, 1e-6])
