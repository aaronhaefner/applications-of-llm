...
def json_to_hf_dataset(json_file: str) -> DatasetDict:
    ...
    formatted_data = {
        key: [entry.get(key, None) for entry in data] for key in keys
    }
...
def push_dataset_to_hub(
    dataset_dict: DatasetDict, repo_name: str, private: bool = True
):
    ...
    # print(f"Dataset pushed to Hugging Face in repo: {repo_name}")
...
if __name__ == "__main__":
    ...
    REPO_NAME = (
        "my-hf-dataset-repo"  # Set your Hugging Face repository name here
    )
