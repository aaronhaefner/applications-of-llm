...
def paraphrase(text, model, tokenizer, num_return_sequences=5, num_beams=5):
    """
    Generate paraphrases for a given text using PEGASUS.
    """
...
with open("../input/question_query.json", "r") as file:
    data = json.load(file)
...
with open("../input/paraphrased_examples.json", "w") as outfile:
